...
print(Horas, ":", Minutos, ":", Segundos)   # agregando los segundos

#==>  EJERCICIO 2 
""" ¿Qué radio debe tener una esfera, para que su volumen sea el mismo al de un cubo de lado 5 cm? """
'Volumen esfera = (4/3)*pi*r^3' 'Volumen cubo = l^3'
lado = 5
Volumen_cubo = lado**3
radio = ((3/4) * Volumen_cubo / pi)**(1/3)
print('EJERCICIO 2')
print('EL radio de la esferea debe ser:', radio)

#==>  EJERCICIO 3 
""" ¿Cuantas veces supera, el area de un cubo, al area de una esfera, si el lado del
cubo es 10 cm. Y el radio de la esfera 2 cm ? """
'Area del cubo = 6 * l^2' 'Area de la esfera = 4*pi*r^2'
l = 10
r = 2
Area_cubo = 6 * l**2
Area_esfera = 4*pi*r**2
relacion = Area_cubo/Area_esfera
print('EJERCICIO 3')
print('EL área del cubo supera a la de la esfera', relacion, 'veces.')
